<template>
  <div class="img_fundo">
    ...
    <div class="container" id="fundo_UNOPAR">
      <br> <br>
      <div class="top_cp">
        <br />
        <h2 class="text-center" id="logo_cp">
          Projetos desenvolvidos na Universidade Norte do Paraná
        </h2>
        <br>
      </div>
      <br><br>
      ...
      <div class="text-center">
        ...
        <div class="btn-limpar">
          <button type="" class="btn btn-danger" @click="reload">Limpar</button>
        </div>
      </div> 
    </div>
...
#fundo_UNOPAR{
background-image:linear-gradient( rgba(255,255,255,.8) 0%,rgba(255,255,255,.8) 100%), url("UNOPAR.jpg"); 
